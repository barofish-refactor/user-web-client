...
const Login: NextPageWithLayout = () => {
  ...
  return (
    <div className='relative flex flex-1 flex-col justify-between pb-6 pt-[15dvb]'>
      ...
      <div className='relative px-6'>
        ...
        <div className='mt-[30px]'>
          <div className='relative flex justify-center'>
            <h3 className='z-[1] bg-white px-2 text-center text-[14px] font-medium leading-[22px] -tracking-[0.03em] text-[#C2C3C7]'>
              또는
            </h3>
      ...
      <div className='flex items-center justify-center gap-1.5 text-[13px] font-semibold leading-[20px] -tracking-[0.39px]'>
