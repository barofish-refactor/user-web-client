  ...
  return (
    <div className='flex h-full w-full flex-col items-center overscroll-y-contain bg-white pb-[90px]'>
      ...
      <div className='sticky top-0 z-50 flex h-[56px] w-full shrink-0 items-center justify-between gap-3.5 bg-white px-4'>
        ...
        />
        <p className='text-[18px] font-bold -tracking-[0.03em] text-grey-10'>
        ...
        <div className='w-full flex-1 overflow-auto scrollbar-hide'>
          <div className='flex flex-col gap-4 px-4 py-[22px]'>
            <div className='flex items-center'>
              <p className='w-[84px] text-[18px] font-medium leading-[24px] -tracking-[0.03em] text-grey-10'>
                배송지명
              </p>
              <input
            ...
            <div className='flex items-center'>
              ...
              <PatternFormat
                ...
                inputMode='numeric'
                spellCheck={false}
                className='flex h-[44px] flex-1 items-center rounded-lg border border-grey-80 px-3 text-[16px] font-medium leading-[22px] -tracking-[0.03em] text-grey-10 placeholder:text-grey-60 focus:border-primary-50'
                value={tel}
            ...
            <div className='flex flex-col gap-2'>
              <div className='flex items-center'>
                ...
                <div className='flex flex-1 items-center gap-2'>
                  ...
                  >
                    <p className='text-[16px] font-bold leading-[22px] -tracking-[0.03em] text-primary-50'>
                      주소 찾기
                    </p>
                  </button>
                  <DaumPostcode
              ...
              <div className='flex flex-col gap-2 pl-[84px]'>
                <div className='flex h-[44px] w-full items-center rounded-lg border border-grey-80  bg-grey-90 px-3'>
                  <p className='text-[16px] font-medium leading-[22px] -tracking-[0.03em] text-grey-10'>
                    {address}
                  </p>
                </div>
                <input
                  className='flex h-[44px] w-full items-center rounded-lg border border-grey-80 px-3 text-[16px] font-medium leading-[22px] -tracking-[0.03em] text-grey-10 placeholder:text-grey-60 focus:border-primary-50'
            ...
            {message?.value === '직접입력' && (
              <div>
                <div className='ml-[84px] h-[130px] flex-1 rounded-lg border border-grey-80 py-3'>
                  <textarea
                    spellCheck={false}
                    className='h-full  w-full px-3 text-[16px] font-medium leading-[22px] -tracking-[0.03em] text-grey-10 placeholder:text-grey-80'
                    placeholder='직접 입력'
                    value={content}
            ...
            <div className='mt-[22px]'>
              ...
              >
                ...
                />
                <p className='text-[18px] font-medium leading-[24px] -tracking-[0.03em] text-grey-40'>
                  기본 배송지로 저장
                </p>
              </button>
            </div>
      ...
      <div className='fixed bottom-0 z-50 w-[375px] bg-white px-4 pb-7 pt-2 max-md:w-full'>
        ...
        >
          <p
            className={cm('text-[18px] font-bold -tracking-[0.03em] text-grey-10', {
              'text-white': isEdit,
            })}
          >
            {isEdit ? '저장하기' : '배송지 추가'}
