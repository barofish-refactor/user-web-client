...
const ProductItem = () => {
  ...
  return (
    ...
    >
      ...
      <p className='mt-2 line-clamp-2 text-start text-[14px] font-normal leading-[22px] -tracking-[3%] text-grey-10'>
      ...
      <p className='-mt-0.5 text-start text-[13px] font-normal leading-[20px] -tracking-[3%] text-grey-60 line-through'>{`${formatToLocaleString(
        15000,
      )}원`}</p>
      <div className='mt-0.5 flex items-center gap-0.5'>
        <Image
